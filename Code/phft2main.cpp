...
int main()
{
	...
	cout<<"minimo estratto :"<<m->key<<endl<<endl;
...
//	cout<<h5->ritornaMin()->key<<endl;
	...
	cout<<h5->findMin()->key<<" "<<h5->ritornaTesta()->key<<endl;
	h5->pisanodelete(16);
...
//	cout<<"main"<<endl;
	...
	h2m->insert(171);
	h2m->insert(171);
	//struttura impazzisce se inserisco elementi uguali
	...
	cout<<"max estratto :"<<mm->key<<endl<<endl;
...
//	cout<<h5->ritornaMin()->key<<endl;
	...
	cout<<h5m->findMax()->key<<" "<<h5m->ritornaTesta()->key<<endl;
	h5m->pisanodelete(16);
	h5m->printlistaradici();
	h5m->print();
